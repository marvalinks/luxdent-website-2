...
@section('content')
    ...
    <div class="row">
        <form action="{{route('admin.courses.modules.edit', [$module->moduleid])}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="bock">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" required type="text" name="name" value="{{$module->name}}">
                        </div>
                        <div class="form-group">
                            <label>Cost <span class="req">*</span></label>
                            <input class="form-control" required step="0.001" type="number" name="cost" value="{{$module->cost}}">
                        </div>
