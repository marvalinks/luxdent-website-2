...
@section('content')
    ...
    <div class="row">
        <form autocomplete="off" action="{{route('admin.courses.lessons.add', [$module->moduleid])}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="bock">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly class="form-control" type="text" value="{{$module->name}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="url" name="audio_url">
                        </div>
                        <div class="form-group">
                            <label>Lesson duration <span class="req">*</span></label>
                            <input class="form-control" required type="number" min="1" name="duration">
                        </div>
