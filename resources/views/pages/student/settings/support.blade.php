    ...
    <div class="block padding-top-30">
        ...
        <div class="block padding-top-20">
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="{{route('student.my.questions')}}" class="btn btn-warning btn-block">My Questions</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="block">
                    <div class="app-heading app-heading-small">
                        ...
                        <div class="title">
                            <h2>General</h2>
                            <p>Main questions about course</p>
                        </div>
                    </div>
                    <div class="app-faq">
            ...
            <div class="modal-body">
                <div class="app-heading app-heading-small app-heading-condensed">
                    <div class="title">
                        ...
                        <p>
                            To ask a question, kindly visit the lesson and click on the <strong>Ramu</strong>
                            button to ask question relaxed to that particular lesson
                        </p>
                    </div>
                </div>
                {{-- <form action="{{route('student.support')}}" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="bock">
                            ...
                            @endif
                            <div class="form-group">
                                <label>Lesson <span class="req">*</span></label>
                                <select name="moduleid" class="form-control" required>
                                    <option value="">-choose-</option>
                                    @foreach ($modules as $module)
                                    <option value="{{$module->moduleid}}">{{$module->module->name}}</option>
